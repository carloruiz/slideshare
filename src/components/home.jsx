...
class Home extends Component {
 constructor(props) {
  ...
  render() {
    ...
    const {ordering, slides} = this.props
    return (
      <React.Fragment>
        <Header/>
        <div className="home">
          { ordering.map(topic =>
            <Topic topic={topic} slides={slides[topic]} />
          )}
        </div>
      </React.Fragment>
    );
